						...
						for(var i=0;i<listi.length;i++){
							...
							td.addEventListener(lib.config.touchscreen?'touchend':'click',function(){
								...
								if(event.zhongmode){
									...
									// switch(link){
									// 	case 'zhu':case 'zhong':case 'fan':num=100;break;
									// 	case 'nei':num=100;break;
									// }
								}
						...
						if(game.players[i]!=game.zhu&&game.players[i]!=game.me){
							...
							if(get.config('unbalanced_mode')){
								switch(game.players[i].identity){
									case 'zhu':case 'zhong':case 'fan':num=30;break;
									case 'nei':num=30;break;
								}
							}
			...
			chooseCharacterOL:function(){
				...
				next.setContent(function(){
					...
					if(event.zhongmode){
						...
						let finalNum=100;
						if(lib.configOL.unbalanced_mode) finalNum=100;
					...
					for(var i=0;i<game.players.length;i++){
						if(game.players[i]!=game.zhu){
							...
							if(lib.configOL.unbalanced_mode&&!event.zhongmode){
								switch(game.players[i].identity){
									case 'zhu':numFinal=100;
									case 'zhong':numFinal=100;
									case 'fan':numFinal=100;
									break;
									case 'nei':numFinal=100;break;
								}
							}
